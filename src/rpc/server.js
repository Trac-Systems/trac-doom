  ...
  const server = http.createServer(async (req, res) => {
    try {
      ...
      if (u.pathname === '/startGame' && req.method === 'POST') {
        ...
        const maxPlayers = (body.maxPlayers !== undefined && body.maxPlayers !== null)
          ? parseInt(body.maxPlayers, 10)
          : undefined
        await peer.protocol_instance.api.startGame(body.gid, body.mode, maxPlayers)
